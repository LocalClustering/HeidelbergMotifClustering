/******************************************************************************
 * kway_motif_cond_refinement_commons.h 
 * *
 * 
...
class kway_motif_cond_refinement_commons  {
        public:

                kway_motif_cond_refinement_commons( PartitionConfig & config );
                virtual ~kway_motif_cond_refinement_commons();
...
inline unsigned kway_motif_cond_refinement_commons::getUnderlyingK() {
        return m_local_degrees.size();
}

inline void kway_motif_cond_refinement_commons::init(PartitionConfig & config) {
...
inline bool kway_motif_cond_refinement_commons::incident_to_more_than_two_partitions(graph_access & G, NodeID & node) {
...
inline bool kway_motif_cond_refinement_commons::int_ext_degree( graph_access & G, 
                                                           const NodeID & node,
                                                           const PartitionID lhs,
                                                           const PartitionID rhs,
                                                           EdgeWeight & int_degree,
...
inline Gain kway_motif_cond_refinement_commons::compute_gain(graph_access & G, 
                                                        NodeID & node, 
                                                        PartitionID & max_gainer, 
                                                        EdgeWeight & ext_degree) {
