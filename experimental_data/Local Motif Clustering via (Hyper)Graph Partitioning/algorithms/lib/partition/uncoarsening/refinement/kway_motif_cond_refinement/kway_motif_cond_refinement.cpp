/******************************************************************************
 * kway_motif_cond_refinement.cpp 
 * *
 * 
...
#include "kway_motif_cond_refinement.h"
#include "kway_motif_cond_refinement_core.h"
#include "kway_stop_rule_motif_cond.h"
#include "quality_metrics.h"
#include "random_functions.h"

kway_motif_cond_refinement::kway_motif_cond_refinement() {
}

kway_motif_cond_refinement::~kway_motif_cond_refinement() {
}

EdgeWeight kway_motif_cond_refinement::perform_refinement(PartitionConfig & config,
...
void kway_motif_cond_refinement::setup_start_nodes(PartitionConfig & config, graph_access & G, complete_boundary & boundary,  boundary_starting_nodes & start_nodes) {
