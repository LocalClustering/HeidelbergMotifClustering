...
class kway_stop_rule_motif_cond {
public:
        kway_stop_rule_motif_cond(PartitionConfig & config) {};
        kway_stop_rule_motif_cond() {};
        virtual ~kway_stop_rule_motif_cond() {};
...
class kway_simple_stop_rule_motif_cond : public kway_stop_rule_motif_cond {
public:
        kway_simple_stop_rule_motif_cond(PartitionConfig & config) {};
        virtual ~kway_simple_stop_rule_motif_cond() {};
...
inline bool kway_simple_stop_rule_motif_cond::search_should_stop(unsigned int min_cut_idx, 
                                                      unsigned int cur_idx, 
                                                      unsigned int search_limit) {
...
class kway_adaptive_stop_rule_motif_cond : public kway_stop_rule_motif_cond {
public:
        kway_adaptive_stop_rule_motif_cond(PartitionConfig & config) : m_steps(0), 
                                                            m_expected_gain(0.0), 
                                                            m_expected_variance2(0.0), 
                                                            pconfig(&config) {}
        virtual ~kway_adaptive_stop_rule_motif_cond() {};
...
inline bool kway_adaptive_stop_rule_motif_cond::search_should_stop(unsigned int min_cut_idx, 
                                                        unsigned int cur_idx, 
                                                        unsigned int search_limit) {
