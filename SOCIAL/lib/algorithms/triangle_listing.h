...
public:
        ...
        std::vector <std::vector<NodeID>>* triangle_run_uncontracted(graph_access &G, NodeID seed_node, float epsilon_depth, std::vector<bool> &lastLayerNodes, NodeID &hypergraph_node_count, std::vector<NodeID> &prelim_partition, std::vector <NodeID> *&mapping2);
