...
struct PartitionConfig
{
	...
	bool suppress_partitioner_output;
        ...
        long long int seed_node; //motif clustering
        int beta; //motif clustering
        int no_threads; //motif clustering
        bool write_cluster; //motif clustering
        bool keep_parallel_nets; //motif clustering
        bool fix_nodes; //motif clustering
        long long triangle_count; //motif clustering
        bool print_cut; //motif clustering
        bool mqi_improvement; //motif clustering
        bool mqi_improvement_star; //motif clustering
        bool mqi_improvement_clique; //motif clustering
        bool mqi_improvement_lawler; //motif clustering
        bool fix_seed_node; //motif clustering
        bool label_prop_ls; //motif clustering
        bool fm_ls; //motif clustering
        int repetition_timelimit; //motif clustering
        bool just_count_triangles; //motif clustering
	...
	int sep_num_loc_fm_reps;
        ...
        std::vector< short int > bfsDepths;
