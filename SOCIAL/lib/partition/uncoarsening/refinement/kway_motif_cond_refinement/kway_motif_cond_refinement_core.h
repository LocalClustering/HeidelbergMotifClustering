/******************************************************************************
 * kway_motif_cond_refinement_core.h 
 *
 * XXX.
 * XXX
 *****************************************************************************/
...
class kway_motif_cond_refinement_core  {
        public:
                kway_motif_cond_refinement_core( );
                virtual ~kway_motif_cond_refinement_core();
...
inline bool kway_motif_cond_refinement_core::move_node(PartitionConfig & config, 
                graph_access & G, 
                NodeID & node, 
                vertex_moved_hashtable & moved_idx, 
                refinement_pq * queue, 
