...
inline void configuration::standard( PartitionConfig & partition_config ) {
        ...
        partition_config.seed_node                              = -1; //motif clustering
        partition_config.no_threads                             = 1; //motif clustering
        partition_config.beta                                   = 3; //motif clustering
        partition_config.write_cluster                          = false; //motif clustering
        partition_config.keep_parallel_nets                     = false; //motif clustering
        partition_config.fix_nodes                              = false; //motif clustering
        partition_config.triangle_count                         = UNDEFINED_TRIANGLE_COUNT; //motif clustering
        partition_config.print_cut                              = false; //motif clustering
        partition_config.mqi_improvement                        = false; //motif clustering
        partition_config.mqi_improvement_star                   = false; //motif clustering
        partition_config.mqi_improvement_clique                 = false; //motif clustering
        partition_config.mqi_improvement_lawler                 = false; //motif clustering
        partition_config.fix_seed_node                          = true; //motif clustering
        partition_config.label_prop_ls                          = false; //motif clustering
        partition_config.fm_ls	                                = false; //motif clustering
        partition_config.repetition_timelimit                   = 3600; //motif clustering
        partition_config.just_count_triangles                   = false; //motif clustering
	...
	partition_config.sep_loc_fm_unsucc_steps       = 50;
        ...
        partition_config.bfsDepths.push_back(3);
        partition_config.bfsDepths.push_back(4);
        partition_config.bfsDepths.push_back(5);
