...
class graph_io {
        public:
                ...
                static
		int readCommunity(graph_access & G, const std::string & filename, std::vector<NodeID> & community, PartitionID block);
                ...
                static
		void writeCommunity(std::vector<NodeID> & best_community, const std::string & filename);
