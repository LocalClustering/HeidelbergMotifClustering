/******************************************************************************
 * multitry_kway_fm_motif_cond.cpp 
 * *
 * 
...
int multitry_kway_fm_motif_cond::perform_refinement(PartitionConfig & config, graph_access & G, 
...
int multitry_kway_fm_motif_cond::perform_refinement_around_parts(PartitionConfig & config, graph_access & G, 
...
int multitry_kway_fm_motif_cond::start_more_locallized_search(PartitionConfig & config, graph_access & G, 
                                                   complete_boundary & boundary, bool init_neighbors, 
        ...
        kway_motif_cond_refinement_core refinement_core;
